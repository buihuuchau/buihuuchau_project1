...
<body>
    <div class="than">
        ...
        <div class="than2">
            <center>Chọn bàn muốn đổi để tìm hóa đơn</center><br>
            <form action="xulydoiban1.php" method="post">
                <!-- <label for="ngaytao">Chọn ngày hôm nay:</label>
